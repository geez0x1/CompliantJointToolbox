...
I_l_ds              = 0.0867;               %% Torsion bar inertia [kg m^2] (datasheet)
...
params.('I_l')      = r_I_l * 1.1001;    	%% Torsion bar inertia [kg m^2]
% Stiffnesses
...
params.('d_l')      = 14.786 * (1/10);      %% Torsion bar damping [Nms/rad]
...
params.('d_l_n')    = 16.162 * (1/10);      %% Torsion bar damping - negative direction [Nms/rad]
