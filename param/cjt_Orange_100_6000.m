...
params.('I_m')      =     0.3594;  %% Motor rotor inertia [kg m^2]
params.('I_g')      =     0.1120;  %% Gear inertia [kg m^2]
...
% Coulomb friction
params.('d_cm')     =     3.3000;  %% Motor Coulomb damping [Nm]
params.('d_cg')     =     3.7000;  %% Gearbox Coulomb damping [Nm]
params.('d_cl')     =     0.0000;  %% Torsion bar Coulomb damping [Nm]
% Asymmetric Coulomb friction
params.('d_cm_n')   =     3.3000;  %% Motor Coulomb damping - negative direction [Nm]
params.('d_cg_n')   =     3.7000;  %% Gearbox Coulomb damping - negative direction [Nm]
...
params.('dq_p')     =     6.1827;  %% Max. reachable speed (output) [rad/s]
% Thermal parameters
