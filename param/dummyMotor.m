...
params.('ripm_a1')  = [];                   %% Cosine amplitudes ([Nm] and/or [], see torque_ripple()) (second param to be updated!)
params.('ripm_a2')  = [];                   %% Sine amplitudes [Nm] ([Nm] and/or [], see torque_ripple())
params.('ripm_f')   = [];                   %% Spatial frequencies [periods/revolution]
% Misc
params.('n')        = 160;                  %% Transmission ratio []
