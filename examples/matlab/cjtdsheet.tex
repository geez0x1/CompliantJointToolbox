...
The actuator efficiency varies with the operating point as visible in Fig.~\ref{fig:EfficiencyCurve}. BLDC motors typically 
display poor efficiency at very low torques, where most of the generated mechanical power is dissipated  to overcome 
friction. The efficiency also drops for very high torques.

\end{multicols}

\section*{Thermal Characteristics}
%\section*{\textcolor{cjtblue}{Actuator Efficiency}}
\begin{figure}[tb]
