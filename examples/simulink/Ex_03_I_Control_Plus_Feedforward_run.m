% EX_03 An example of a purely integral troqrue controller with feedforward action.
%
% Author::
%  Joern Malzahn
%  Wesley Roozing
...
% #! 03: Integral control with feed-forward action.
...
mdlName = 'Ex_03_I_Control_Plus_Feedforward.mdl';
