% EX_10 An example of open loop torque control augmented by a disturbance observer.
%
% Author::
%  Joern Malzahn
%  Wesley Roozing
...
% #! 10: Open-loop with friction compensation.
...
mdlName = 'Ex_10_Open_Loop_With_Disturbance_Observer.mdl';
