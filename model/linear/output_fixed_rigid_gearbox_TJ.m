...
%  difference that it works with a transformed state vector. The
%  transformed vector represents torques and jerks instead of positions and
%  velocities, with the exception of the output link position and velocity,
%  required to represent the overall position of the system.
%
% Examples::
%
% Author::
...
%  Wesley Roozing
%
% See also output_fixed_rigid_gearbox.
