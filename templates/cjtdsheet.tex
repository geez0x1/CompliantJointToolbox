...
%
    ...
    \textcolor{white}{\textbf{Electrical}}   
        ...
        & \textcolor{white}{\textbf{Value}}
    \tabularnewline
        Winding \newline Resistance        & $\symArmatureresistance$  & $\Omega$          & \valArmaturresistance   \tabularnewline    \rowcolor{lightgray}
...
\begin{center}
    \captionof{figure}{Torque-Speed Diagram of the actuator.}
...
\emph{Peak Torque:} Torque corresponding to the peak current $\symPeakcurrent$.
...
\emph{Peak Electrical Power:} Computed as a product of rated voltage $\symRatedvoltage$ and peak current $\symPeakcurrent$.

\emph{Peak Mechanical Power:} Computed as the product of the peak torque $\symPeaktorque$ and peak speed $\symPeakspeed$.
