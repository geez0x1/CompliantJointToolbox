%%GETNONLINEARDYNAMICS Template for a dummy implementation for nonlinear
...
%%
%% Notes::
%%   The function created from this template just outputs a zero vector with 
%%   dimensions equal to the state vector.
%%
%% Examples::
%%
%% Author::
